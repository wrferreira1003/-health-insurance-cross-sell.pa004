...
class SHAPImportanceRandomForestClassifier(RandomForestClassifier):
    ...
    def feature_importances_(self):
        check_is_fitted(self) #Verifica se o modelo esta ajustado, verificando a presenã de atributos ajustados.

        explainer = shap.TreeExplainer(self) #Tree SHAP é um método rápido e exato para estimar valores de SHAP 
                                             #para modelos de árvores e conjuntos de árvores, sob várias suposições possíveis sobre dependência de recursos.
